      ...
      <div className="px-8  mt-[5vh] relative flex flex-col ">
        <div className=" hidden lg:block">
          <Animate delay={200} type="slideLeft">
            <div className="text-[80px] font-semibold">Dhootha</div>
          </Animate>
          ...
          <div className="mt-10 flex flex-col gap-6 lg:mt-[13vh] ">
            ...
            <Animate delay={500} type="slideDown">
              <p className="lg:max-w-[30vw] lg:text-[15px]">
                Welcome to Dhootha, a cutting-edge digital marketing and design
                solution crafted by Shaik Afrid. We are dedicated to the art of
                digital transformation, and Dhootha is the embodiment of our
                commitment to redefining your online presence. At Shaik Afrid,
                ...
                this dynamic environment. With Dhootha, we offer a comprehensive
