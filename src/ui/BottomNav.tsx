          ...
          <div
            onClick={() => {
              window.location.href =
                "mailto:afridayan01@gmail.com?subject=hey&body=Hello!";
            }}
          >
            <Animate delay={200} type="slideDown">
              <div className="transition-all cursor-pointer lg:hover:text-black lg:hover:bg-primary flex items-center gap-3 duration-700 ease-in-out  border border-foreground/30  w-fit  px-4 py-3 rounded-full">
                afridayan01@gmail.com <FaArrowUp />
              </div>
            </Animate>
          </div>
      ...
      <div>
        <Animate delay={400} type="slideDown">
          <div className="text-foreground/30 mt-[4vh] w-fit text-xs text-center  ">
            © 2024 Dhootha Promotions. All Rights Reserved.
          </div>
        </Animate>
      </div>
      <div className="cursor-pointer" onClick={()=>{window.open("https://afriddev.vercel.app/")}}>
        <Animate delay={500} type="slideDown">
          <div className="text-foreground mt-[4vh] w-fit text-xs text-center  ">
            Made with 💛 by Shaik Afrid
          </div>
        </Animate>
      </div>
    </div>
